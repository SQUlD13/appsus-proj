...
const DEMO_GIF = 'https://media1.giphy.com/media/l2JJBzwv06HNhcORi/giphy.gif?cid=ecf05e47fo5m1tgydi8uefdrig7tj1bg3ssh145pl9aigf6w&rid=giphy.gif'
const DEMO_GIFS = [
...
function getNote(id) {
    ...
    return query()
        .then(notes => {
            console.log("🚀 ~ file: keep.service.js ~ line 27 ~ getNote ~ notes", notes)
